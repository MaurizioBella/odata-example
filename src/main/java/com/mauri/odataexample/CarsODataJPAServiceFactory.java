...
public class CarsODataJPAServiceFactory extends ODataJPAServiceFactory {
    ...
    public ODataJPAContext initializeODataJPAContext() throws ODataJPARuntimeException {
        ...
        //log.debug("[I32] >>> initializeODataJPAContext()");
    ...
    static class EntityManagerWrapper implements EntityManager {
        ...
        public void persist(Object entity) {
             ...
             log.debug("[I68] persist: entity.class=" + entity.getClass()
                                  .getSimpleName()); 
...
//            log.debug("[I74] merge: entity.class=" + entity.getClass()
//                    .getSimpleName());
            return delegate.merge(entity);
        }

        public void remove(Object entity) {
//            log.debug("[I78] remove: entity.class=" + entity.getClass()
//                    .getSimpleName());
        ...
        public void close() {
            log.debug("[I229] close");
            delegate.close();
        }

        public boolean isOpen() {
            boolean isOpen = delegate.isOpen();
            log.debug("[I236] isOpen: " + isOpen);
            return isOpen;
        }

        public EntityTransaction getTransaction() {
            log.debug("[I240] getTransaction()");
